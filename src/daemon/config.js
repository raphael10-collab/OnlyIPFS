// https://github.com/ipfs-shipyard/ipfs-desktop/blob/master/src/daemon/config.js
...
function migrateConfig (ipfsd) {
  ...
  if (store.get(REVISION_KEY) >= REVISION) {
    return;
  }
...
// webui://- was an earlier experiment that should be cleared out.
//
